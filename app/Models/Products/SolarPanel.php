...
class SolarPanel extends Product
{
    ...
    public function setAverageMonthlyEnergyWAttribute($value)
    {
        $this->attributes['average_monthly_energy_w'] = (new NumberFormat())->doubleToInteger($value);
    }
    ...
    public function getAverageMonthlyEnergyWFormattedAttribute()
    {
        return (new NumberFormat())->integerToDouble($this->attributes['average_monthly_energy_w']);
    }
