import SelectedProductCard from "../../Create/UI/SelectedProductCard";

export default function EditSelectedProductsSection({ title, products, icon: Icon, onQuantityChange, onRemove}) {
