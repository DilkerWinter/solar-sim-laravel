...
export default function CreateBaseProduct( { formData, productTypes, setFormData, productTypeForm, setProductTypeForm } ) {
    ...
    return (
            <section className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
                ...
                <SelectField
                  ...
                  required
                  value={productTypeForm.value}
                  onChange={(value) => setProductTypeForm({ visible: true, value })}
                />
            </section>
    );
}
